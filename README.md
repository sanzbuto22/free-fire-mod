...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>FreeFire</code> &nbsp;·&nbsp; <code>freefire</code>
</p>
...
Free Fire mod menu base — emulator aim assist, ESP toggle, anti-ban notes.

LATAM/SEA search free-fire-mod more than free-fire-cheat.
...
```bash
dotnet restore free-fire-mod.slnx
dotnet build free-fire-mod.slnx -c Release
dotnet test free-fire-mod.slnx -c Release
```
